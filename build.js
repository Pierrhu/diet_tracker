...
const FILES=['data/recipes.js','data/calculator.js','data/user.js','data/log.js','js/utils.js','js/state.js','js/nav.js','js/week.js','js/planner.js','js/macros.js','js/recipeDetail.js','js/recipes.js','js/shopping.js','js/history.js','js/settings.js','js/main.js'];
function strip(code){
